...
class PaymentMethodPolicy
{
    ...
    const NAMEITEM = 'medios de pago';

    public function viewAny(User $user): Response
    {
        return $user->hasPermissionTo('view payment_methods')
            ? Response::allow()
    ...
    {
        return $user->hasPermissionTo('create payment_methods')
            ? Response::allow()
    ...
    {
        return $user->hasPermissionTo('edit payment_methods')
            ? Response::allow()
    ...
    {
        return $user->hasPermissionTo('delete payment_methods')
            ? Response::allow()
