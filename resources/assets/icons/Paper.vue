<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      stroke-width="2"
    />
    <path d="M7 7L11 7" stroke-width="2" stroke-linecap="round" />
    <path d="M8 11H7" stroke-width="2" stroke-linecap="round" />
    <path d="M7 15L10 15" stroke-width="2" stroke-linecap="round" />
  </svg>
</template>
